import { ChecklistItem, Guide } from './models';

export const CHECKLIST: ChecklistItem[] = [
  {
    id: 'pps',
    title: 'Get a PPS number',
    detail:
    ...
    when: 'Before or in week 1',
    guideSlug: 'pps-number',
  },
  {
    id: 'bank',
    title: 'Open an Irish current account',
    detail:
  ...
  },
  {
    ...
    when: 'Week 1–2',
    guideSlug: 'revenue-myaccount',
  },
  {
    id: 'tcc',
    title: 'Check your tax credit certificate',
    detail:
    ...
    when: 'Week 2',
    guideSlug: 'paye-usc-prsi',
  },
  {
    id: 'payslip',
    title: 'Read the first payslip against a calculator',
    detail:
    ...
    when: 'First payday',
    guideSlug: 'first-payslip',
  },
  {
    id: 'pension',
    title: 'Confirm the pension scheme',
    detail:
...
export const GUIDES: Guide[] = [
  {
    slug: 'first-payslip',
    title: 'Your first Irish payslip',
    kicker: 'Pay',
    summary:
    ...
    sections: [
      {
        heading: 'What ‘started five days in’ means',
        body: 'The month still has its full length. Starting on the 6th of a 31-day month means 26 paid days if payroll uses calendar days. Five unpaid days come off a full month’s salary, not off the annual rate itself. The €74,000 figure is a rate. August is a slice of that rate.',
      },
      {
      ...
      },
      {
        ...
        body: 'PPS number, Irish bank IBAN, and confirmation of the pension scheme. If you have a P45 from another 2026 Irish job, give it in; cumulative PAYE will then include that earlier pay.',
      },
    ],
  },
  {
    slug: 'paye-usc-prsi',
    title: 'PAYE, USC and PRSI',
    kicker: 'Tax',
    summary: 'Ireland takes three statutory slices from an employee payslip. They are not one ‘tax’ line.',
    takeaways: [
    ...
    sections: [
      {
        heading: 'PAYE',
        body: 'For 2026 a single employee has a €44,000 standard-rate cut-off at 20%, with the balance at 40%. Tax credits (typically €2,000 personal plus €2,000 PAYE) come off the tax bill, not off salary. Married one-income cut-off is €53,000 with a €4,000 personal credit plus the PAYE credit. These bands are frozen into 2026.',
      },
      {
        heading: 'USC',
        body: 'Universal Social Charge is calculated on gross pay. Employee pension contributions do not reduce it. 2026 bands: 0.5% on the first €12,012, 2% to €28,700, 3% to €70,044, 8% above that. Income of €13,000 or under is exempt.',
      },
      {
        heading: 'PRSI',
        body: 'Most employees are Class A. The employee rate is 4.2% until 30 September 2026 and 4.35% from 1 October. There is a weekly exemption at very low earnings (€352 or less in that week). PRSI is how you build a social insurance record for benefits later.',
      },
    ],
  },
  {
    slug: 'pension',
    title: 'Pension in a new Irish job',
    kicker: 'Pension',
    summary: 'Occupational schemes and MyFutureFund are different products with different tax treatment.',
    takeaways: [
    ...
    sections: [
      ...
      },
      {
        ...
        body: '‘Am I in an occupational scheme that exempts me from MyFutureFund?’ The answer tells you which calculator setting to use and what will appear on the payslip.',
      },
    ],
  },
  {
    slug: 'pps-number',
    title: 'Getting a PPS number',
    kicker: 'Arrival',
    summary: 'Almost nothing in Irish payroll works cleanly until you have a Personal Public Service number.',
    takeaways: [
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Tax credit certificates, MyFutureFund enrolment, some bank onboarding, and GP registration often need it. Tell payroll the number the day you have it so they can stop emergency tax.',
      },
    ],
  },
  {
    ...
    title: 'Emergency tax',
    kicker: 'Tax',
    summary: 'A new job with no tax credit certificate can withhold far more than the calculator’s ‘normal’ PAYE.',
    takeaways: [
    ...
    sections: [
      {
        heading: 'Two emergency flavours',
        body: 'If the employer has your PPS number, payroll can use a week-1 / month-1 basis: 20% up to that period’s cut-off, 40% above, with a period’s credits. If they do not, deduction can be 40% on everything with no credits. Both still take USC and PRSI.',
      },
      {
  ...
  {
    slug: 'revenue-myaccount',
    title: 'Revenue myAccount',
    kicker: 'Arrival',
    summary: 'This is the portal for your tax credit certificate, job record and year-end review.',
    takeaways: [
    ...
    sections: [
      {
        heading: 'Tax credit certificate',
  ...
  {
    slug: 'healthcare',
    title: 'Healthcare while you pay PRSI',
    kicker: 'Arrival',
    summary:
    ...
    sections: [
      {
        heading: 'GP and A&E',
        body: 'Find a GP who will take new patients. A&E is for emergencies. Bring PPS number and EHIC/GHIC if you have one from another EU country for the transition period.',
      },
      {
        heading: 'Medical card',
        body: 'Medical cards and GP visit cards depend on income and circumstances. A €74,000 salary will usually be above medical-card limits for a single person, but check HSE rules if you have dependants.',
      },
    ],
  },
];
